...
#' @description Function listing the names of existing documents and making a new name by adding one to the highest existing increment. This ensures that no old number is assigned again.
