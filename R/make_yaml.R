...
make_yaml <- function(selected, doctype){
  ...
  if (doctype == "Note"){
    ...
    yaml <- c(
      ...
      '    css: ["format/css/notes.css", "https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.0/css/all.css"]',
      '    fig_width: 8',
      '    fig_height: 6',
      '    fig_caption: true',
      '    mathjax: default',
    ...
    yaml <- c(
      ...
      '  rmarkdown::html_document:',
      '    self_contained: false',
      '    css: ["format/css/pages.css", "https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.0/css/all.css"]',
      '    fig_width: 8',
      '    fig_height: 6',
      '    fig_caption: true',
      '    mathjax: default',
    ...
    yaml <- c(
      ...
      '  rmarkdown::html_document:',
      '    self_contained: false',
      '    css: ["format/css/videos.css", "https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.0/css/all.css"]',
      '    fig_width: 8',
      '    fig_height: 6',
      '    fig_caption: true',
      '    mathjax: default',
